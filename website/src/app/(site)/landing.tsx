            ...
            <div className="flex flex-col justify-center sm:text-center lg:py-12 lg:text-left xl:w-5/12 xl:py-20">
              <div className="mx-auto mb-8 inline-flex space-x-6 lg:mx-0">
                ...
                >
                  ...
                  <Lucide.ExternalLink className="size-5 text-gray-400" aria-hidden="true" />
                </Link>
              </div>
              ...
              <div className="mx-auto max-w-2xl">
                ...
                <p className="mt-12 mb-8 text-center text-gray-500 leading-relaxed md:mb-12 lg:text-left xl:text-lg">
              ...
              <div>
                <div className="flex flex-col gap-4 sm:flex-row sm:justify-center lg:justify-start">
                  ...
                  <div className="group inline-flex items-center gap-2.5 rounded-lg border border-gray-200 bg-gray-100 px-4 py-3 text-center font-medium text-gray-600 text-sm outline-none ring-gray-300 md:text-base">
