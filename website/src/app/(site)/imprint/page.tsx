    ...
    <div className="mx-auto max-w-screen-xl px-4 md:px-8">
      <div className="container mx-auto max-w-screen-xl py-12">
        ...
        <div className="mb-16 space-y-4">
          <h1 className="font-bold text-4xl text-slate-900 tracking-tight md:text-5xl dark:text-white">
            Imprint
          </h1>
        ...
        <div className="space-y-12">
          <section>
            <h2 className="mb-6 font-semibold text-2xl text-slate-900 dark:text-white">
              Twistail Authors
            </h2>
          ...
          <section>
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              <p className="text-slate-600 leading-7 dark:text-slate-300">
