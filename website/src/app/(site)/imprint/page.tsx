    ...
    <div className="mx-auto max-w-7xl px-6">
      <div className="container mx-auto max-w-screen-xl py-16">
        ...
        <div className="mb-16 space-y-4">
          <h1 className="font-bold text-4xl text-zinc-900 tracking-tight md:text-5xl dark:text-white">
            Imprint
          </h1>
        ...
        <div className="space-y-12">
          <section>
            <h2 className="mb-6 font-semibold text-2xl text-zinc-900 dark:text-white">
              Twistail Authors
            </h2>
          ...
          <section>
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              <p className="text-zinc-600 leading-7 dark:text-zinc-300">
