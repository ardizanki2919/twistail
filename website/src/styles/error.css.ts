...
export const errorStyles = tv({
  slots: {
    ...
    gradientBg: [
      ...
      'bg-gradient-to-b from-slate-100 via-transparent to-transparent dark:from-slate-950',
      'before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] before:from-slate-200/10 before:via-transparent before:to-transparent dark:before:from-slate-800/10',
    ...
    title: 'mt-4 font-bold text-3xl text-slate-900 tracking-tight sm:text-5xl dark:text-white',
    description: 'mt-6 font-medium text-base text-slate-600 leading-7 dark:text-slate-400',
    pre: [
      'w-full overflow-x-auto rounded-lg bg-slate-50 p-4 dark:bg-slate-900',
      'border border-slate-200 dark:border-slate-800',
      'mt-6 shadow-sm dark:shadow-slate-900/50',
    ],
    code: [
    ...
    secondaryButton: [
      ...
      'hover:border-slate-400 hover:bg-slate-50 hover:shadow-lg hover:shadow-slate-200/10',
      'transition-all duration-200',
      'dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100',
      'dark:hover:border-slate-600 dark:hover:bg-slate-700 dark:hover:shadow-slate-900/30',
      'focus:outline-none focus:ring-2 focus:ring-slate-200/50 focus:ring-offset-2',
      'focus:ring-offset-white dark:focus:ring-offset-slate-950',
    ],
  },
})
