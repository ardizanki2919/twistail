...
export const errorStyles = tv({
  slots: {
    ...
    pre: [
      ...
      'mt-6 shadow-xs dark:shadow-neutral-900/50',
    ],
    code: [
    ...
    primaryButton: [
      ...
      'focus:outline-hidden focus:ring-2 focus:ring-blue-500/50 focus:ring-offset-2',
    ...
    secondaryButton: [
      ...
      'hover:border-neutral-400 hover:bg-neutral-50 hover:shadow-md hover:shadow-neutral-200/10',
      'transition-all duration-200',
      'dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-100',
      'dark:hover:border-neutral-600 dark:hover:bg-neutral-700 dark:hover:shadow-neutral-900/30',
      'focus:outline-hidden focus:ring-2 focus:ring-neutral-200/50 focus:ring-offset-2',
      'focus:ring-offset-white dark:focus:ring-offset-neutral-900',
    ],
  },
})
