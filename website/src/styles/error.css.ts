...
export const errorStyles = tv({
  slots: {
    ...
    gradientBg: [
      ...
      'bg-gradient-to-b from-zinc-100 via-transparent to-transparent dark:from-zinc-950',
      'before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] before:from-zinc-200/10 before:via-transparent before:to-transparent dark:before:from-zinc-800/10',
    ...
    title: 'mt-4 font-bold text-3xl text-zinc-900 tracking-tight sm:text-5xl dark:text-white',
    description: 'mt-6 font-medium text-base text-zinc-600 leading-7 dark:text-zinc-400',
    pre: [
      'w-full overflow-x-auto rounded-lg bg-zinc-50 p-4 dark:bg-zinc-900',
      'border border-zinc-200 dark:border-zinc-800',
      'mt-6 shadow-sm dark:shadow-zinc-900/50',
    ],
    code: [
      'font-mono text-sm text-zinc-800 dark:text-zinc-200',
      'selection:bg-blue-500/20 dark:selection:bg-blue-500/30',
      'selection:text-zinc-900 dark:selection:text-zinc-100',
    ],
    actions: 'mt-10 flex items-center justify-center gap-x-4',
    primaryButton: [
      'min-w-[140px] cursor-pointer rounded-md bg-blue-500 px-6 py-3 font-semibold text-sm text-white',
    ...
    secondaryButton: [
      'min-w-[140px] rounded-md px-6 py-3 font-semibold text-sm',
      'border border-zinc-300 bg-white/80 text-zinc-900',
      'hover:border-zinc-400 hover:bg-zinc-50 hover:shadow-lg hover:shadow-zinc-200/10',
      'transition-all duration-200',
      'dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100',
      'dark:hover:border-zinc-600 dark:hover:bg-zinc-700 dark:hover:shadow-zinc-900/30',
      'focus:outline-none focus:ring-2 focus:ring-zinc-200/50 focus:ring-offset-2',
      'focus:ring-offset-white dark:focus:ring-offset-zinc-950',
    ],
  },
})
