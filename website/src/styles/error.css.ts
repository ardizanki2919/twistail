...
export const errorStyles = tv({
  slots: {
    ...
    gradientBg: [
      ...
      'bg-gradient-to-b from-gray-100 via-transparent to-transparent dark:from-gray-950',
    ...
    secondaryButton: [
      ...
      'hover:border-gray-400 hover:bg-gray-50 hover:shadow-lg hover:shadow-gray-200/10',
      'transition-all duration-200',
