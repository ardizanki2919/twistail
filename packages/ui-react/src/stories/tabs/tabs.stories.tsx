...
export const VariantCurved: Story = {
  render: () => (
    <Tabs defaultValue="tab1">
      <TabsList variant="curved">
        <TabsTrigger value="tab1">Returns</TabsTrigger>
        <TabsTrigger value="tab2">Shipping</TabsTrigger>
      </TabsList>
      <div className="mt-4 ml-2">
...
export const VariantCurvedWithIcon: Story = {
  render: () => (
    <Tabs defaultValue="tab1">
      <TabsList variant="curved">
        ...
        <TabsTrigger value="tab3" className="gap-1.5" disabled>
          <Lucide.Book className="-ml-1 size-4" aria-hidden="true" />
          User Guide
        </TabsTrigger>
      </TabsList>
      <div className="mt-4 ml-2">
