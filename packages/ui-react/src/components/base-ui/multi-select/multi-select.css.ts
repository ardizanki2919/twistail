...
const multiSelectStyles = tv({
  slots: {
    ...
    placeholderText: 'text-muted-foreground text-sm pl-3 pr-2 py-2 w-full items-start text-left',
    badge: [
    ...
    commandInput: 'px-3 py-2 text-sm',
    ...
    checkboxItem: [
      ...
      'rounded-sm py-1.5 pr-2 pl-8 outline-hidden transition-colors sm:text-sm focus-visible:bg-accent',
    ...
    checkboxItemEmptyIndicator: 'size-4 rounded-sm border border-border',
