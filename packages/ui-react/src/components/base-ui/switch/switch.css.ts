...
const switchStyles = tv({
  slots: {
    root: [
      ...
      'shadow-inner ring-1 ring-inset transition-all bg-muted ring-border/50',
    ...
    thumb: [
      ...
      'shadow-md outline-none transition-all duration-150 ease-in-out',
      'focus:border-none focus:outline-none bg-white',
